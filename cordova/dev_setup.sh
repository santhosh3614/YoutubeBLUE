...
show_help () {
    ...
    message_info ""
    message_info "    ./dev_setup.sh   # This is the same as using the -i option."
    message_info "    ./dev_setup.sh -c -i"
    echo ""
}
...
if [[ $init = 1 ]] || [[ $plugins = 1 ]] ; then
    message_info "Adding Whitelist Plugin: cordova-plugin-whitelist"
    cordova plugin add cordova-plugin-whitelist

    message_info "Adding Geolocation Plugin: cordova-plugin-geolocation"
    cordova plugin add cordova-plugin-geolocation

    message_info "Adding StatusBar Plugin: cordova-plugin-statusbar"
